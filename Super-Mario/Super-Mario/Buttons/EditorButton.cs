...
namespace Super_Mario
{
    ...
    {
        public EditorButton(Vector2 aPosition, Point aSize) : base(aPosition, aSize)
        {
        ...
        {
            StringManager.DrawStringMid(aSpriteBatch, my8bitFont, "Editor", myBoundingBox.Center.ToVector2(), Color.Black, 1.1f);
