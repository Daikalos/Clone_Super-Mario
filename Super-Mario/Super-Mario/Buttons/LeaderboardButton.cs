...
namespace Super_Mario
{
    ...
    {
        public LeaderboardButton(Vector2 aPosition, Point aSize) : base(aPosition, aSize)
        {
        ...
        {
            StringManager.DrawStringMid(aSpriteBatch, my8bitFont, "High Score", myBoundingBox.Center.ToVector2(), Color.Black, 1.1f);
