...
namespace Super_Mario
{
    ...
    {
        public PlayButton(Vector2 aPosition, Point aSize) : base(aPosition, aSize)
        {
        ...
        {
            StringManager.DrawStringMid(aSpriteBatch, my8bitFont, "PLAY", myBoundingBox.Center.ToVector2(), Color.Black, 1.1f);
