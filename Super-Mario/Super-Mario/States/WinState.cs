...
namespace Super_Mario
{
    class WinState : State
    {
        ...
        {
            StringManager.DrawStringMid(aSpriteBatch, my8bitFont, "YOU WIN", new Vector2(aWindow.ClientBounds.Width / 2, (aWindow.ClientBounds.Height / 2) - 96), Color.Black, 1.2f);
            ...
            StringManager.DrawStringLeft(aSpriteBatch, my8bitFont, "Press return to go back to menu", new Vector2(12, aWindow.ClientBounds.Height - 12), Color.Black * 0.8f, 0.5f);
        }
